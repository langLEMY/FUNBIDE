...
public interface IReactivarServicioUseCase : IUseCase<Guid, ServicioDto>
{
}

public sealed class ReactivarServicioUseCase(
    IServicioRepository servicioRepository,
    ICurrentUserService currentUser,
    IAuditoriaLogService auditoriaLogService) : IReactivarServicioUseCase
{
